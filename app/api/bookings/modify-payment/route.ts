...
/**
 * POST /api/bookings/modify-payment
 * 
 * Create a payment intent for upgrading to a more expensive option during booking modification.
 */
  ...
  try {
    ...
    const paymentIntent = await stripe.paymentIntents.create({
      ...
      metadata: {
        ...
        type: "booking_modification_upgrade",
        trackName: booking.track.name,
      },
      description: `Booking modification upgrade fee for ${booking.track.name}`,
    })
